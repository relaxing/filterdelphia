...
void main() {
  ...
  palette_posterize[0] = vec4( 249, 234, 212, 255 );
  palette_posterize[1] = vec4( 14, 10, 255, 255 );
  palette_posterize[2] = vec4( 83, 198, 252, 255 );
  palette_posterize[3] = vec4( 0, 204, 13, 255 );
  palette_posterize[4] = vec4( 242, 255, 0, 255 );
  palette_posterize[5] = vec4( 255, 40, 0, 255 );
  palette_posterize[6] = vec4( 255, 0, 250, 255 );
